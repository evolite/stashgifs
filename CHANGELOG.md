...
## [5.43.1] - 2026-04-21\n\n### Changed\n- Fix all open SonarQube issues
- Fix typo in README.md for Configurable Feeds
- Export BUILD_HASH from version.ts so settings page displays it\n
...
### Changed
- Remove Stash Plugin badge from README
- Add SonarCloud quality and tech badges to README
- Reduce duplication further to pass SonarQube quality gate (Round 3)
- Reduce code duplication to fix SonarQube quality gate
- Fix 21 SonarQube issues to pass quality gate

## [5.38.1] - 2026-03-05

### Changed
- Fix toggle off-state contrast and restructure Settings tabs
...
### Changed
- Improve reel mode scrolling, autoplay, and pause behavior
- Unify rating dialog behavior across posts
...
### Changed
- Remove ScenePlayer dev layout

## [5.31.1] - 2026-02-03

### Changed
- Improve stability and error handling
- Stabilize media loading and feed startup
...
### Changed
- Tighten action button sizing and force initial load
